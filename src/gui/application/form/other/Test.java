...
public class Test extends javax.swing.JFrame {
    ...
    private void applyTableStyle(JTable table) {
        ...
        cmdAdd.setIcon(new FlatSVGIcon("gui/icon/svg/add.svg", 0.35f));
        cmdUpdate.setIcon(new FlatSVGIcon("gui/icon/svg/edit.svg", 0.35f));
        cmdDelete.setIcon(new FlatSVGIcon("gui/icon/svg/delete.svg", 0.35f));
