...
import gui.menu.mode.ManagerToolBarAccentColor;
...
public class ManagerMenu extends JPanel {
	...
	private final String headerName = "Cinema Managemt";
	...
	private ManagerToolBarAccentColor toolBarAccentColor;
	...
	private void init() {
		...
		panelMenu = new JPanel(new ManagerMenuItemLayout(this));
		...
		toolBarAccentColor = new ManagerToolBarAccentColor(this);
	...
	private void createMenu() {
		...
		for (int i = 0; i < menuItems.length; i++) {
			...
			if (menuName.startsWith("~") && menuName.endsWith("~")) {
				...
				ManagerMenuItem menuItem = new ManagerMenuItem(this, menuItems[i], index++, events);
