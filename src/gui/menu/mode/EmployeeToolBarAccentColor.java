...
public class EmployeeToolBarAccentColor extends JPanel {
	...
	public EmployeeToolBarAccentColor(EmployeeMenu menu) {
		this.menu = menu;
		init();
	}
	...
	private void init() {
		...
		selectedButton.addActionListener((ActionEvent e) -> {
			int y = (selectedButton.getPreferredSize().height - (toolbar.getPreferredSize().height + UIScale.scale(10)))
					/ 2;
			show(EmployeeToolBarAccentColor.this, (int) getWidth() + UIScale.scale(4), y);
		});
