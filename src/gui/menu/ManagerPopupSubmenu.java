...
public class ManagerPopupSubmenu extends JPanel {
	...
	public ManagerPopupSubmenu(ComponentOrientation orientation, ManagerMenu menu, int menuIndex, String menus[]) {
		this.menu = menu;
